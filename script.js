...
function randomColor() {
    function c() {
        ...
        //adds a leading zero if necessary and returns the last two characters of the string.
        return ("0" + String(hex)).substr(-2);
    }
    //calls the c function three times to generate three random hexadecimal digits and concatenates them with a "#" character to form a full six-digit hexadecimal color code.
    return "#" + c() + c() + c();
}